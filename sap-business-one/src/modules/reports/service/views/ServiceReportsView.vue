  ...
  <div class="space-y-6">
      ...
      <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p class="text-gray-600">
            Generate service calls, technician performance, and SLA compliance reports
          </p>
        </div>
      ...
      <div class="relative top-20 mx-auto p-5 border w-11/12 max-w-4xl shadow-lg rounded-md bg-white">
        <div class="flex items-center justify-between mb-4">
          <h3 class="text-lg font-medium text-gray-900">
            {{ editingReport ? 'Edit Report' : 'New Service Report' }}
          </h3>
    ...
    >
      <div class="relative top-10 mx-auto p-5 border w-11/12 max-w-7xl shadow-lg rounded-md bg-white max-h-screen overflow-y-auto">
        <div class="flex items-center justify-between mb-4">
          <h3 class="text-lg font-medium text-gray-900">Service Report</h3>
          <button @click="closeModal" class="text-gray-400 hover:text-gray-600">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                stroke-linecap="round"
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
      <div class="px-4 py-5 sm:p-6">
        <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Recent Service Reports</h3>
        ...
        <div v-else-if="reports.length === 0" class="text-center py-8 text-gray-500">
          ...
          <p class="mt-1 text-sm text-gray-500">Get started by generating your first service report.</p>
        </div>
...
const formatReportType = (type) => {
  const types = {
    'SERVICE_CALLS': 'Service Calls Report',
...
const loadReports = async () => {
  ...
  try {
    ...
    reports.value = [
      {
        id: '1',
        name: 'Monthly Service Calls',
        description: 'Service calls summary for this month',
        type: 'SERVICE_CALLS',
