<template>
  <form @submit.prevent="handleSubmit" class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-4">
      <h3 class="text-base font-medium text-gray-900 mb-4">Goods Issue</h3>
    ...
    <div class="bg-white rounded-lg shadow p-4">
      <div class="flex items-center justify-between mb-4">
        <h4 class="text-lg font-medium text-gray-900">Issue Items</h4>
...
import type { GoodsIssue, GoodsIssueFormData, GoodsIssueLineItem } from '../types'

// Props and Emits
const props = defineProps<{
  initialData?: GoodsIssue
}>()

const emit = defineEmits<{
  submit: [data: GoodsIssueFormData]
  cancel: []
}>()

// Form Data
const formData = ref<GoodsIssueFormData>({
  postingDate: '',
  documentDate: '',
  series: 'GI-2024',
  businessPartnerCode: '',
...
const addLineItem = () => {
  const newItem: GoodsIssueLineItem = {
    itemCode: '',
    description: '',
    quantity: 0,
    unitPrice: 0,
...
const hasLineItemData = (item: GoodsIssueLineItem): boolean => {
