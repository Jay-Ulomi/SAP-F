<template>
  <form @submit.prevent="handleSubmit" class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-4">
      <h3 class="text-base font-medium text-gray-900 mb-4">Invoice Header</h3>
...
import type { ArInvoice, ArInvoiceFormData, Customer, InvoiceLineItem } from '../types'
