      ...
      <div class="flex items-center justify-between mb-4">
        <div class="flex items-center space-x-4">
          ...
          <div class="flex items-center space-x-2">
            <label for="invoiceType" class="text-sm font-medium text-gray-700"> Type: </label>
            <select
              id="invoiceType"
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <thead v-if="formData.type === 'Item'" class="bg-gray-50">
            <tr>
              ...
              <th
                class="w-12 px-2 py-2 text-center text-xs font-medium text-gray-500 uppercase"
              ></th>
            </tr>
          </thead>
            ...
            <tr v-for="(item, index) in formData.lineItems" :key="index">
              ...
              <td class="px-2 py-1">
                <select
                  ...
                  @change="handleTaxCodeChange(index)"
                >
        ...
        <div class="w-80 space-y-2">
          ...
          <div class="flex justify-between text-base font-bold border-t pt-2">
            ...
            <span class="text-gray-900">{{
              formatCurrency(total + (formData.freightAmount || 0))
            }}</span>
          </div>
        </div>
      </div>
...
import type { ApInvoiceFormData, ServiceItem } from '../types'
...
const handleQuantityInput = (index: number) => {
  ...
  handleLineItemInput(index)
}

const handleTaxCodeChange = (index: number) => {
  updateTaxRate(index)
  handleLineItemInput(index)
}
