  ...
  <form @submit.prevent="handleSubmit" class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
      <div class="flex justify-between items-center mb-6">
        <h2 class="text-lg font-semibold text-gray-900">Purchase Return</h2>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <div class="md:col-span-2">
          ...
          <textarea
            ...
            rows="2"
            placeholder="Purchase return created for returned items"
            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-gray-400 focus:ring-gray-400 text-sm text-gray-900 placeholder-gray-700"
          ></textarea>
        </div>
      </div>
      ...
      <div class="flex items-center justify-between mb-4">
        <div class="flex items-center space-x-4">
          ...
          <div class="flex items-center space-x-2">
            <label for="returnType" class="text-sm font-medium text-gray-700">
              Type:
            </label>
            <select
              id="returnType"
...
import type { PurchaseReturnFormData, ServiceItem } from '../types'
