<template>
  <form @submit.prevent="handleSubmit" class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-4">
      <h3 class="text-base font-medium text-gray-900 mb-4">Goods Receipt Header</h3>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <!-- Purchase Order ID -->
        <div>
          <label for="purchaseOrderId" class="block text-sm font-medium text-gray-700 mb-1">
            Purchase Order *
          </label>
          <input
            id="purchaseOrderId"
            ...
            <tr v-for="(item, index) in formData.lineItems" :key="index">
              ...
              <td class="px-3 py-2">
                <select
                  ...
                  class="block w-24 text-sm border-gray-300 rounded-md focus:border-sap-blue focus:ring-sap-blue"
                >
                  <option v-for="status in qualityStatuses" :key="status" :value="status">
...
import type { GoodsReceiptFormData } from '../types'
...
const qualityStatuses = Object.values(QualityStatus)
...
const getLineTotal = (item: { receivedQuantity: number; unitPrice: number }): number => {
  return item.receivedQuantity * item.unitPrice
}
...
const formatQualityStatus = (status: QualityStatus): string => {
