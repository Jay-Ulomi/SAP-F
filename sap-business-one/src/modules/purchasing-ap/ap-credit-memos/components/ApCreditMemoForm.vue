  ...
  <form @submit.prevent="handleSubmit" class="space-y-6">
    <div class="bg-white rounded-lg shadow p-6">
      <div class="flex justify-between items-center mb-6">
        <h2 class="text-lg font-semibold text-gray-900">A/P Credit Memo</h2>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
        <div>
          ...
          <select
            ...
            required
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-gray-400 focus:ring-gray-400 sm:text-sm"
          >
            <option value="">Select Series</option>
            <option value="APM-001">APM-001</option>
            <option value="APM-002">APM-002</option>
          </select>
        </div>
        ...
        <div>
          <label for="creditMemoDate" class="block text-sm font-medium text-gray-700">Document Date</label>
          <input
            id="creditMemoDate"
        ...
        <div>
          <label for="requiredDate" class="block text-sm font-medium text-gray-700">Required Date</label>
          <input
            id="requiredDate"
        ...
        <div>
          <label for="referenceNo" class="block text-sm font-medium text-gray-700">Reference No.</label>
          <input
            id="referenceNo"
      ...
      <div class="flex items-center justify-between mb-4">
        <div class="flex items-center space-x-4">
          ...
          <div class="flex items-center space-x-2">
            <label for="creditType" class="text-sm font-medium text-gray-700">
              Type:
            </label>
            <select
              id="creditType"
    ...
    <div class="flex justify-end space-x-3 pt-4 border-t">
      ...
      <button
        ...
        class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 disabled:opacity-50 disabled:cursor-not-allowed"
      >
...
import type { ApCreditMemoFormData, ServiceItem } from '../types'
...
const hasLineItemData = (item: any): boolean => {
  return item.itemCode.trim() !== '' ||
         ...
         (item.creditReason && item.creditReason.trim() !== '')
}
...
const subtotal = computed(() => {
  ...
  const serviceTotal = formData.value.serviceItems.reduce((sum: number, service: any) => {
    const discount = service.discount || 0
    const totalLC = service.totalLC || 0
    const discountAmount = totalLC * (discount / 100)
...
const totalTax = computed(() => {
  ...
  const serviceTax = formData.value.serviceItems.reduce((sum: number, service: any) => {
