  ...
  <form @submit.prevent="handleSubmit" class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <div class="md:col-span-2">
          ...
          <textarea
            ...
            rows="2"
            placeholder="Purchase quotation created for procurement needs"
            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-gray-400 focus:ring-gray-400 text-sm text-gray-900 placeholder-gray-700"
          ></textarea>
        </div>
      </div>
    ...
    <div class="flex justify-end space-x-3">
      <button
        type="button"
        @click="$emit('cancel')"
        class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400"
      >
        Cancel
      </button>
      <button
        ...
        class="px-4 py-2 text-sm font-medium text-white bg-gray-600 border border-transparent rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 disabled:opacity-50 disabled:cursor-not-allowed"
      >
...
const formData = ref<any>({
  ...
  requestType: 'Item',
  currency: 'USD',
  remarks: 'Purchase quotation created for procurement needs',
  type: 'Item',
  serviceItems: [
...
const getTaxRate = (taxCode: string): number => {
  switch (taxCode) {
    ...
    case 'VAT-0': return 0
    case 'GST-5': return 5
    case 'GST-12': return 12
    case 'GST-18': return 18
    case 'GST-28': return 28
...
const grandTotal = computed(() => {
  return subtotal.value + totalTax.value + (formData.value.freightAmount || 0)
})
