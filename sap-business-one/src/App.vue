...
const modules = ref([
  ...
  },
  {
    ...
    submodules: [
      ...
      { id: 'payments', name: 'Payments', route: '/sales/payments' },
      { id: 'dunning', name: 'Dunning', route: '/sales/dunning' },
  ...
  },
  {
    ...
    submodules: [
      ...
      { id: 'goods-receipts', name: 'Goods Receipts', route: '/inventory/goods-receipts' },
      { id: 'transfers', name: 'Stock Transfer', route: '/inventory/transfers' },
